...
customElements.define('compodoc-menu', class extends HTMLElement {
    ...
    render(isNormalMode) {
        ...
        <nav>
            <ul class="list">
                <li class="title">
                    <a href="index.html" data-type="index-link">nskr-todo documentation</a>
                </li>
                ...
                <li class="chapter">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? 'id="components-links"' : 'id="xs-components-links"' }>
                            ...
                            <li class="link">
                                <a href="components/TaskAddEditComponent.html" data-type="entity-link" >TaskAddEditComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/TaskDeleteComponent.html" data-type="entity-link" >TaskDeleteComponent</a>
                            </li>
                            <li class="link">
                                <a href="components/TaskFilterComponent.html" data-type="entity-link" >TaskFilterComponent</a>
                            </li>
                            <li class="link">
                            ...
                            <li class="link">
                                <a href="components/ThemeComponent.html" data-type="entity-link" >ThemeComponent</a>
                            </li>
                            <li class="link">
                        ...
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="directives-links"' : 'id="xs-directives-links"' }>
                                ...
                                <li class="link">
                                    <a href="directives/PageComponent.html" data-type="entity-link" >PageComponent</a>
                                </li>
                            </ul>
                        </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="injectables-links"' : 'id="xs-injectables-links"' }>
                                ...
                                <li class="link">
                                    <a href="injectables/TasksEffects.html" data-type="entity-link" >TasksEffects</a>
                                </li>
                                <li class="link">
                    ...
                    <li class="chapter">
                        ...
                        <ul class="links collapse " ${ isNormalMode ? ' id="interfaces-links"' : 'id="xs-interfaces-links"' }>
                            ...
                            <li class="link">
                                <a href="interfaces/RequestStatus.html" data-type="entity-link" >RequestStatus</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/Task.html" data-type="entity-link" >Task</a>
                            </li>
                            <li class="link">
                                <a href="interfaces/TasksState.html" data-type="entity-link" >TasksState</a>
                            </li>
                        </ul>
                    </li>
                        <li class="chapter">
                            ...
                            <ul class="links collapse " ${ isNormalMode ? 'id="pipes-links"' : 'id="xs-pipes-links"' }>
                                <li class="link">
                                    <a href="pipes/ToDatePipe.html" data-type="entity-link" >ToDatePipe</a>
                                </li>
                            </ul>
                        </li>
                    <li class="chapter">
